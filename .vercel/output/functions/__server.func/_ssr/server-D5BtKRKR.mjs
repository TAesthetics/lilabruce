...
import { i as getSql, n as ensureDbReady, r as getPglite } from "./db-D6L-vCpY.mjs";
...
async function deliverPasswordReset(to, url) {
...
var latestResetLink = createServerFn({ method: "POST" }).validator((input) => input).handler(createSsrRpc("8ad59534dc2193fea32f658e0667ce7b743d8ce813d8825092f615d1d781dab5"));
/**
...
//#endregion
export { latestResetLink as i, authConfigured as n, gateIdentityEnabled as r, auth as t };

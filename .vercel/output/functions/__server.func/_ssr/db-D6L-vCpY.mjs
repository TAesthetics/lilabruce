//#region node_modules/.nitro/vite/services/ssr/assets/db-D6L-vCpY.js
...
async function createPgliteSql() {
	globalRef.__pgliteInstance__ ??= (async () => {
		...
		const dataDir = process.env.PGLITE_DIR || (process.env.RAILWAY_ENVIRONMENT ? "/tmp/pglite" : "/workspace/.data/pglite");
	...
	const migrate = async () => {
		const migrations = /* #__PURE__ */ Object.assign({
			...
			"/migrations/0002_temple.sql": _0002_temple_default,
			"/migrations/0003_prompt_quota.sql": _0003_prompt_quota_default,
			"/migrations/0004_paid_day.sql": _0004_paid_day_default,
			"/migrations/0005_mail_outbox.sql": _0005_mail_outbox_default,
			"/migrations/0006_findings.sql": _0006_findings_default,
			"/migrations/0007_subscription_billing.sql": _0007_subscription_billing_default
		});
